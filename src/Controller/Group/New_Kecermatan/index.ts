...
class Kecermatan {
    ...
    public async insertData(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            if (!req.body?.secureId) {
                ...
                Result = await this.newKecermatanService.createData(payload);
            } else {
                payload.secureId = req.body?.secureId;
                Result = await this.newKecermatanService.updateData(payload)
            }
    ...
    public async activation(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.activation(payload);
            return Responses.success(res, Result)
        } catch (error) {
            return Responses.failed(res, error, next);
        }
    ...
    public async findAll(req: Request, res: Response, next: NextFunction): Promise<any> {
        try {
            ...
            const Result = await this.newKecermatanService.findAll(search);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
    ...
    public async deleteData(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.deleteData(payload);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
