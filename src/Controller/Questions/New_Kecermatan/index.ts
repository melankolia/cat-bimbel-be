...
import NewKecermatanService from "../../../Service/Question/New_Kecermatan";
import { PayloadCreateKecermatanSectionVO, PayloadRequestKecermatanQuestionVO } from "../../../Types";

class New_Kecermatan {
    newKecermatanService: NewKecermatanService

    constructor() {
        this.newKecermatanService = new NewKecermatanService();
    }
    ...
    public async findAll(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.findAll(secureId, type);
    ...
    public async insertSection(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.insertSection(Payload);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
    ...
    public async insertQuestion(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.insertQuestion(Payload);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
    ...
    public async deleteSection(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.deleteSection(secureId);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
    ...
    public async deleteQuestion(req: Request, res: Response, next: NextFunction): Promise<any> {
        ...
        try {
            ...
            const Result = await this.newKecermatanService.deleteQuestion(secureId);
            return Responses.success(res, Result);
        } catch (error) {
            return Responses.failed(res, error, next);
        }
